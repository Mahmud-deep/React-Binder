...
export default function Footer() {
    return (
      <div>
        ...
        <a className="email" href="mahmudkhan_deep@yahoo.com" alt="Link to email"><img style={{ "padding":"15px" }} src={emaillogo} alt="Email Jacob" width="64"></img></a>
        </div>
        <div className='d-flex justify-content-center' style={{ "backgroundColor":"#13293d", "color": "white" }}>
        &copy; Mahmud Khan Deep
        </div>
      </div>
    );
  }