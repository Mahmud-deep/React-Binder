...
import thumbnail from '../../assets/green-resume-logo.png';
        ...
        <div className="container">
          <div className="row" style={{"marginBottom":"17.5%"}}>
            ...
            <img className="resume" style={{"border":"5px solid #13293d","borderRadius":"3px","opacity":".8","width":"225px", "margin": "10px 0px"}} id="resume" src={thumbnail} alt="thumbnail of resume"></img>
              <p><a href="https://drive.google.com/file/d/1jX9gL5f2DlEF_sh7rjXkDxvrOXVnLmXn/view?usp=drive_link" alt="Open PDF Resume" target="_blank" rel="noreferrer"><button style={{ marginTop: '20px', "backgroundColor":"#42c5f5","color":"white","border":"none","borderRadius":"4px","padding":"4px 10px 4px","whiteSpace":"nowrap" }} type="submit" value="Submit">Open  Resume (PDF)</button></a></p>
            </div>
